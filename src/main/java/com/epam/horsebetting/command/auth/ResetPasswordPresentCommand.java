...
public class ResetPasswordPresentCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public ResetPasswordPresentCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws IllegalCommandTypeException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.PageConfigType.RESET_PASSWORD);
