...
public class ViewRacePresentCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public ViewRacePresentCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws IllegalCommandTypeException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.PageConfigType.RACES_VIEW);
