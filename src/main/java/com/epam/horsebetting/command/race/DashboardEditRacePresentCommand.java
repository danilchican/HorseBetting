...
public class DashboardEditRacePresentCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public DashboardEditRacePresentCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws CommandTypeNotFoundException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.PageConfigType.DASHBOARD_RACES_EDIT);
