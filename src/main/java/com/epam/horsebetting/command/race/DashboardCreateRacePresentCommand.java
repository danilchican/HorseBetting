...
public class DashboardCreateRacePresentCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public DashboardCreateRacePresentCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws CommandTypeNotFoundException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.PageConfigType.DASHBOARD_RACES_CREATE);
