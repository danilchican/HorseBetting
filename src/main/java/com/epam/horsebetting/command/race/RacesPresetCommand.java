...
public class RacesPresetCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public RacesPresetCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws CommandTypeNotFoundException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.PageConfigType.RACES_INDEX);
