...
public class UpdateProfileUserSettingsCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public UpdateProfileUserSettingsCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws CommandTypeNotFoundException {
        ...
        String page = PageConfig.getInstance().takeAddress(PageConfig.Page.PROFILE_SETTINGS);
