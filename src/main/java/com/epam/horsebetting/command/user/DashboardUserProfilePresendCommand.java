...
public class DashboardUserProfilePresendCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public DashboardUserProfilePresendCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws CommandTypeNotFoundException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.PageConfigType.DASHBOARD_USERS_VIEW);
