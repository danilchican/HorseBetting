...
public class DashboardCreateHorsePresentCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public DashboardCreateHorsePresentCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws CommandTypeNotFoundException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.Page.DASHBOARD_HORSES_CREATE);
