...
public class DashboardEditHorsePresentCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public DashboardEditHorsePresentCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws IllegalCommandTypeException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.PageConfigType.DASHBOARD_HORSES_EDIT);
