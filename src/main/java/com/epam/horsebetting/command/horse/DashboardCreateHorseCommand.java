...
public class DashboardCreateHorseCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public DashboardCreateHorseCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws CommandTypeNotFoundException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takeAddress(PageConfig.Page.DASHBOARD_HORSES_INDEX);
        } catch (ReceiverException e) {
            LOGGER.log(Level.ERROR, e);
            page = PageConfig.getInstance().takeAddress(PageConfig.Page.DASHBOARD_HORSES_CREATE);
        }
