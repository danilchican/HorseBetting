...
public class DashboardRemoveHorseCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public DashboardRemoveHorseCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws CommandTypeNotFoundException {
        ...
        String page = PageConfig.getInstance().takeAddress(PageConfig.Page.DASHBOARD_HORSES_INDEX);
