...
public class ProfileBetsPresentCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public ProfileBetsPresentCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws IllegalCommandTypeException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.PageConfigType.PROFILE_BETS);
