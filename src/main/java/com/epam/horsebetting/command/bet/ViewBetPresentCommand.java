...
public class ViewBetPresentCommand extends AbstractCommand {
     ...
     * @param receiver
     */
    public ViewBetPresentCommand(AbstractReceiver receiver) {
        super(receiver);
    }
    ...
    public void execute(RequestContent request) throws CommandTypeNotFoundException {
        ...
        try {
            ...
            page = PageConfig.getInstance().takePage(PageConfig.PageConfigType.PROFILE_BETS_VIEW);
